...
class PokemonDetail extends Component {
      ...
      this.setState({ pokeAnim: pokecatch }, () => {
        setTimeout(() => {
          ...
          this.setState({ pokeAnim: pokecatchstop, isCatch }, () => {
            setTimeout(() => {
              this.handleClose();
              if (this.state.isCatch) this.handleNameShow();
            }, 2000);
          });
        }, 4000);
      });
  ...
  fetchPokemonDetail() {
    this.props.dispatch(
      PokemonAction.fetchPokemonDetail(this.props.match.params.id)
    );
  }
  ...
  saveMyPokemon() {
    ...
    this.props.dispatch(
      PokemonAction.saveMyPokemonList(data, () => {
  ...
  releaseMyPokemon() {
    this.props.dispatch(
      PokemonAction.releaseMyPokemon(this.props.PokemonDetail.id, () => {
  ...
  componentWillReceiveProps(props) {
    this.setState({
      imgPreview: props.PokemonDetail.sprites.front_default,
      nickname: this.props.PokemonDetail.name
    });
        ...
        <div className="row">
          ...
          <div className="col-md-8">
            <div
              ...
              style={{ display: this.state.myData.nickname ? "block" : "none" }}
            >
                ...
                <table className="table table-striped table-pokemondetail">
                  <tbody>
                    <tr>
                      ...
                      <td>{this.props.PokemonDetail.id}</td>
                    </tr>
                    <tr>
                      <th width="90">Name</th>
        ...
        >
          <Modal.Body>
            ...
            <div className="span-catch-wrapper">
              <span
                className={
                  this.state.isCatch ? "span-catch success" : "span-catch fail"
                }
                style={{
                  display:
              ...
              >
                {this.state.isCatch ? "SUCCESS!!!" : "FAIL!!!"}
              </span>
            </div>
          </Modal.Body>
        </Modal>
